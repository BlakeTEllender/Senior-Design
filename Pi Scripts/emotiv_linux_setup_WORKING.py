...
class EmotivPacket(object): #takes in data
    """
    ...
    def handle_quality(self, sensors):
        ...
        print('Right Here is what we need..........')
...
class Emotiv(object):
    ...
    def setup_posix(self):
        ...
        if os.path.exists('/dev/eeg/raw'):
            ...
            serial, hidraw_filename = get_linux_setup() #returns hidraw2
        ...
        while self.running:
            print ('im running')
            try:
                data = hidraw.readline() #doesn't execute, stops
    ...
    def dequeue(self):
        ...
        """
        try:
            return self.packets.get(), self.chunk.get()
