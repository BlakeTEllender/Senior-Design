...
#os.system("mplayer -ao alsa:device=bluetooth /home/pi/Downloads/meditation1.mp3")
#pygame.mixer.init()
...
filename = '/home/pi/folder/NNoutput2.csv'
...
data = np.array([row for row in data]) #iterate through rows in data
