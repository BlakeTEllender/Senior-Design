...
class Emotiv(object):
    ...
    def setup_windows(self):
        ...
        try:
            ...
            for device in hid.find_all_hid_devices():
                ...
                elif device.product_name == 'USB Dongle':
    ...
    def update_console(self):
        ...
        #f, (F3, F4, P7, FC6, F7, F8, T7, P8, FC5, AF4, T8, O2, O1,
           # AF3) = plt.subplots(14, sharex=True, sharey=True)
        ...
        if self.display_output:
            while self.running:
                ...
                if t_curr == last_tme:
                    ...
                    samp_freq = ['']
                    cycles = cycles + 1
                current_line = [int(self.sensors[k[1]]['value']) for k in
